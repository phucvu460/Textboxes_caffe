...
caffe_root = '/home/goku/TextBoxes/'  # this file is expected to be in {caffe_root}/examples
os.chdir(caffe_root)
import sys
...
image_path='./examples/img/digit.png'
...
plt.savefig('./examples/results/demo_result_digit.jpg')
